        ...
        <div class="col-lg-5">
            ...
            <nav class="navbar navbar-expand-sm">
                ...
                <ul class="navbar-nav py-3">
                    ...
                    <li class="nav-item"> <a class="my-link-style nav-link" href="order.php">Order</a></li>
                    <li class="nav-item"> <a class="my-link-style nav-link" href="change_password.php">Change password</a></li>
...
?>
                    ...
                    <li style="margin-left:-3px;margin-top:15px;font-size:13px" class="nav-item"><?php echo $row['Name']; ?></li>
<?php
